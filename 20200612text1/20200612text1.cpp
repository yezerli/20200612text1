...
int yoloV3()
{
	...
	//coco数据集的名称文件，80类
	string classesFile = "D:\\0612\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "D:\\0612\\yolov3.cfg";
	//权重
	String weights = "D:\\0612\\yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "D:\\0612\\openpose_pose_coco.prototxt";
	String modelBin = "D:\\0612\\caffe_models\\pose\\coco\\pose_iter_440000.caffemodel";
